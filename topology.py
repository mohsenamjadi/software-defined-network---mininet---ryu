...
def myNetwork():
    ...
    net.addLink(s7, sw6)
    net.addLink(s8, sw6)
    net.addLink(sw5, sw7, cls=TCLink, bw=50)
    net.addLink(sw6, sw8, cls=TCLink, bw=50)
    net.addLink(sw6, sw7, cls=TCLink, bw=100)
    net.addLink(sw5, sw8, cls=TCLink, bw=100)

    net.addLink(s9, sw9)
    net.addLink(s10, sw9)
    net.addLink(s11, sw10)
    net.addLink(s12, sw10)
    net.addLink(sw9, sw11, cls=TCLink, bw=50)
    net.addLink(sw10, sw12, cls=TCLink, bw=50)
    net.addLink(sw10, sw11, cls=TCLink, bw=100)
    net.addLink(sw9, sw12, cls=TCLink, bw=100)

    net.addLink(h1, sw13)
    net.addLink(h2, sw14)
    net.addLink(h3, sw16)

    net.addLink(sw3, sw13, cls=TCLink, bw=15)
    net.addLink(sw3, sw14, cls=TCLink, bw=10)
    net.addLink(sw4, sw14, cls=TCLink, bw=5)
    net.addLink(sw7, sw13, cls=TCLink, bw=15)
    net.addLink(sw7, sw14, cls=TCLink, bw=20)
    net.addLink(sw7, sw15, cls=TCLink, bw=5)
    net.addLink(sw8, sw15, cls=TCLink, bw=10)
    net.addLink(sw8, sw16, cls=TCLink, bw=15)
    net.addLink(sw11, sw14, cls=TCLink, bw=10)
    net.addLink(sw12, sw15, cls=TCLink, bw=15)
    net.addLink(sw12, sw16, cls=TCLink, bw=10)
